(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MKApp_mk_preset_style"] = factory(require("MK")["metaEngine"], require("MK.utils"), require("react"), require("immutable"));
	else
		root["MKApp_mk_preset_style"] = factory(root["MK.metaEngine"], root["MK"]["utils"], root["React"], root["Immutable"]);
...
module.exports = {"isMKPresetApp":true,"name":"mk-preset-style","description":"mk-preset-style","version":"1.0.0","license":"MIT","author":"","keywords":["mk","monkey king","react","redux","mk-js","mk-command","mk-preset-style"],"repository":{"type":"git","url":"https://github.com/whatsmk/mk-preset-style.git"},"bugs":{"url":"https://github.com/whatsmk/mk-preset-style/issues"},"homepage":"https://github.com/whatsmk/mk-preset-style#readme","scripts":{"start":"mk start","build":"mk build","pkg":"mk pkg"},"dependencies":{"mk-command":"*","mk-sdk":"*"}};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _mkUtils=__webpack_require__(7);var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
